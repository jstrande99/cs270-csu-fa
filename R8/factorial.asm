...
;
Factorial       AND R6, R6, MinusOne	; Step 3: allocate space for return value
                PUSH R6 		; Step 4: push return address
                PUSH R5			; Step 5: push previous frame pointer
                LD R4, Stack		; Step 6: setup new frame pointer
                AND R0, R0, #0		; Step 7: allocate space for local variable
...
Main            LD    R6, Stack     ; Initialize stack pointer
                ...
                ADD R6, R6, One 	; Step 14: remove parameter from stack
             
                ST Result, R0 		; Store return value in Result
